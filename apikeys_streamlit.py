...
HELICONE_API_KEY = get_secret('HELICONE_API_KEY', 'sk-helicone-ccw7zvi-ihneggq-uomlwwy-gkfgyjy')

# Langfuse Keys for observability and tracing
LANGFUSE_PUBLIC_KEY = get_secret('LANGFUSE_PUBLIC_KEY', 'your_langfuse_public_key_here')
LANGFUSE_SECRET_KEY = get_secret('LANGFUSE_SECRET_KEY', 'your_langfuse_secret_key_here')
